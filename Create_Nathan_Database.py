...
#grep energy
#E_Info=subprocess.call(["python", "grepping_energies.py", "--rootdir"])  
#E_Dict

from grepping_energies import E_Dict

#grep fermi
#F_Info=subprocess.call(["python", "grepping_fermi.py", "--rootdir"])  
#F_Dict
...
with open(f"Database_{args.rootdir[:args.rootdir.find('_')]}.txt", "w") as f:
    f.write(Database)
